...
public class MiniTester {
	...
	private static void listOfUnitsTester() {
		...
		if (!firePeople[0].equals(fireBenders[0])) {
			...
			System.out.println(firePeople[0].toString());
			return;
		} else if (!firePeople[1].equals(fireBenders[1])) {
			System.out.println("Incorrect Unit gotten, should be the Settler.");
			System.out.println(firePeople[0].toString());
			System.out.println(firePeople[1].toString());
			System.out.println(firePeople[2].toString());
			System.out.println(firePeople[4].toString());
			System.out.println(firePeople.length);
			return;
